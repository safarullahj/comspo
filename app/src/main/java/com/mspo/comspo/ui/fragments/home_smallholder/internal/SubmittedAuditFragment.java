...
public class SubmittedAuditFragment extends Fragment {

    private RecyclerView recyclerViewAuditList;
    private SwipeRefreshLayout refreshView;
    private InternalAuditAdapter internalAuditAdapter;

    public static SubmittedAuditFragment newInstance() {
        return new SubmittedAuditFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_submitted_audits, container, false);
