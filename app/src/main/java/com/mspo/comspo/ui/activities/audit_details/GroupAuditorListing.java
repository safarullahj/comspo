...
import com.mspo.comspo.data.remote.model.responses.group_audit_details.Auditor;
import com.mspo.comspo.ui.widgets.CircleImageView;

import java.util.List;

public class GroupAuditorListing {
    private Activity activity;
    private List<Auditor> auditors;


    GroupAuditorListing(Activity activity, List<Auditor> auditors, LinearLayout view) {
